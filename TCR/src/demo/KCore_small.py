...
if __name__ == "__main__":
    ...
    graph=CSRGraph.read_graph_bin(file_path,is_long=False)
    ...
    for i in range(num):
        ...
        p = mutilGPU_kcore(i,num,graph.row_ptr,graph.columns,graph.num_vertices,graph.out_degrees,partition)
