"""
Implementation of PageRank algorithm using the GAS src.framework.
"""
import sys
# sys.path.append('/home/xty/TCRGraph/')
# sys.path.append('/home/ylzhang/Project/TCRGraph/')\
...
class PageRank(GASProgram):
    def __init__(self, graph: CSRCGraph, vertex_data_type=torch.float32, edge_data_type=torch.float32, num_iter=50, **kwargs):
        ...
        self.out_degree = 1 / graph.out_degree(graph.vertices)
    ...
    def gather(self, vertices, nbrs, edges, ptr):
        ...
        # else:
        #     self.out_degree = 1 / self.graph.out_degree(nbrs)
